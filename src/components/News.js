...
const [totalResults, setTotalResults] = useState(0)
    ...
    return (
     <div className='container my-3'>
                    <h1 className="text-center" style={{marginTop: "90px",marginBottom:"20px"}}>NewsBites - Top {capitalizeFirstLetter(props.category)} Headlines!</h1>
                <InfiniteScroll
                ...
                >
                    ...
                    {articles.map((element)=>{
                        ...
                        newsUrl={element.url} 
                        lastUpdate={element.publishedAt}
